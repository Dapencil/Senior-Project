...
int main()
{
    ...
    vector<vector<double>> inputs = readBinaryInputFile("../test_iris.bin", 4, batch_size);
    ...
    CKKSDense layer_4 = CKKSDense(weight_square_4, bias_square_4, false);
    ...
    writePredictionFile("../pred_iris_ckks_square_square.bin", pred);

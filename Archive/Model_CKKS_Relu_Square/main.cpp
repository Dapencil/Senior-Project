...
int main()
{
    ...
    extern vector<vector<double>> weight_relu_0;
    extern vector<double> bias_relu_0;
    CKKSDense layer_0 = CKKSDense(weight_relu_0, bias_relu_0);

    extern vector<vector<double>> weight_relu_2;
    extern vector<double> bias_relu_2;
    CKKSDense layer_2 = CKKSDense(weight_relu_2, bias_relu_2);

    extern vector<vector<double>> weight_relu_4;
    extern vector<double> bias_relu_4;
    CKKSDense layer_4 = CKKSDense(weight_relu_4, bias_relu_4);

    extern vector<vector<double>> weight_relu_6;
    extern vector<double> bias_relu_6;
    CKKSDense layer_6 = CKKSDense(weight_relu_6, bias_relu_6, false);
    ...
    writePredictionFile("../pred_ckks_relu_square_2.bin", pred);

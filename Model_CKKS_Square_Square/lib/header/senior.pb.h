...
template<> ::Prediction* Arena::CreateMaybeMessage<::Prediction>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class Prediction PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Prediction) */ {
 public:
...
// repeated double values = 1;
inline int Prediction::_internal_values_size() const {
  return values_.size();
}
inline int Prediction::values_size() const {
  return _internal_values_size();
}
inline void Prediction::clear_values() {
  values_.Clear();
}
inline double Prediction::_internal_values(int index) const {
  return values_.Get(index);
}
inline double Prediction::values(int index) const {
  // @@protoc_insertion_point(field_get:Prediction.values)
  return _internal_values(index);
}
inline void Prediction::set_values(int index, double value) {
  values_.Set(index, value);
  // @@protoc_insertion_point(field_set:Prediction.values)
}
inline void Prediction::_internal_add_values(double value) {
  values_.Add(value);
}
inline void Prediction::add_values(double value) {
  _internal_add_values(value);
  // @@protoc_insertion_point(field_add:Prediction.values)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
Prediction::_internal_values() const {
  return values_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
Prediction::values() const {
  // @@protoc_insertion_point(field_list:Prediction.values)
  return _internal_values();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >*
Prediction::_internal_mutable_values() {
  return &values_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >*
Prediction::mutable_values() {
  // @@protoc_insertion_point(field_mutable_list:Prediction.values)
  return _internal_mutable_values();
}
